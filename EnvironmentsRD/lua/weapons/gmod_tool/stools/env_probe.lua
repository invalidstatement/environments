...
TOOL.Name = "Atmospheric Probe"
TOOL.Description = "Used to spawn atmospheric probes"

TOOL.Models = { 	["models/props_combine/combine_mine01.mdl"] = {} }
local Models = TOOL.Models --fixes stuph		

TOOL.Entity.Class = "env_probe";
TOOL.Entity.Keys = 0
